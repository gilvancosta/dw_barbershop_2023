...
class ScheduleRepositoryImpl implements ScheduleRepository {
  ...
  Future<Either<RepositoryException, List<ScheduleModel>>> findScheduleByDate(
    ...
    try {
      final Response(:List data) = await restClient.auth.get('/schedules', queryParameters: {'user_id': filter.userId, 'date': filter.date.toIso8601String()});
      ...
      return Failure(RepositoryException(message: 'Erro ao buscar agendamento de uma data'));
