...
import 'package:dw_barbershop_2023/src/features/employee/schedule/appointment_ds.dart';
import 'package:dw_barbershop_2023/src/features/employee/schedule/employee_schedule_vm.dart';
        ...
        children: [
          ...
          scheduleAsync.when(
            ...
            error: (error, stackTrace) {
              log('Erro ao carregar agendamento', error: error, stackTrace: stackTrace);
              return const Center(
                          ...
                          return SizedBox(
                            ...
                            child: Center(
                              child: Column(
                                ...
                                children: [
                                  Text('Cliente: ${calendarTapDetails.appointments?.first.subject}'),
                                  Text('Horário: ${dateFormat.format(calendarTapDetails.date ?? DateTime.now())}'),
                                ],
                              ),
                            ),
                          );
